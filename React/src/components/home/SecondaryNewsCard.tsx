...
export default function SecondaryNewsCard({ article }: { article: WarriorsNewsItem }) {
  return (
    <a
      ...
      className="group flex rounded-2xl bg-white border border-container-border overflow-hidden lift-on-hover focus:outline-none focus-visible:ring-2 focus-visible:ring-primary"
      aria-label={article.title}
    >
      <div className="relative w-[120px] sm:w-[140px] shrink-0 aspect-[4/5] overflow-hidden">
      ...
      <div className="flex-1 p-3 md:p-4 flex flex-col justify-between min-w-0">
        ...
        <p className="font-lato text-xs text-text-light mt-2">
