...
function NewsRailCard({ item }: { item: WarriorsNewsItem }) {
  return (
    <a
      ...
      className="group relative flex-shrink-0 w-[280px] h-[320px] overflow-hidden rounded-2xl focus:outline-none focus-visible:ring-2 focus-visible:ring-primary"
...
export default function NewsSection() {
  ...
  return (
    <section aria-label="Warriors news">
      {loading && (
