...
const NAV_GROUPS = [
  ...
  {
    label: 'Account',
    links: [{ label: 'Profile', to: '/myprofile' }],
  },
];
    ...
    <footer className="relative bg-secondary text-white overflow-hidden">
      ...
      <div className="relative mx-auto max-w-[1280px] px-4 md:px-6 lg:px-8">
        ...
        <div className="md:hidden py-10">
          <div className="flex flex-col gap-4 mb-8">
            <img
              src="/logo.png"
              alt="AFI"
              className="h-20 w-40 object-contain self-start"
            />
            <p className="font-lato text-sm leading-relaxed text-white/60">
              The ultimate fan engagement platform for Golden State Warriors
              fans.
        ...
        <div className="hidden md:flex items-start gap-8 pb-10">
          <p className="font-lato text-xs font-bold uppercase tracking-[0.2em] text-white/40 shrink-0 mt-0.5">
            Legal
          </p>
