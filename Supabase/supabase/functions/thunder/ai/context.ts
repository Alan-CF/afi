...
export const tools = [
      ...
      parameters: {
        ...
        properties: {
          product: {
            type: "string",
            description:
              "The search query for products, e.g., 'running shoes' or 'red t-shirt'",
          },
        },
        required: ["product"],
      },
  ...
  },
  {
    ...
    function: {
      ...
      description:
        "Retrieves the user's currently active shopping cart items. Use this tool for context, its purpose is not show the user its cart.",
      parameters: {
        type: "object",
        properties: {},
      },
